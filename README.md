...
- [x] Кросс-платформенная сборка (Android + Windows + Linix [server\client - both])
- [x] PostgreSQL-бэкенд с серверной частью (TCP) и логированием
- [x] Криптовалютный модуль - виртуальные кошельки, покупка и продажа криптовалют по симулированному курсу c помощью Пуассоновского шума, переводы между кошельками, история операций
